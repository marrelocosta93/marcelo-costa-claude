# pb-05 — Otimizacao de Custos com IA
...
- Nao: "Melhore este codigo"
- Sim: "Extraia a funcao validateEmail para utils/validation.ts"

### 3. Dividir Tarefas Grandes
- Nao: "Implemente todo o modulo de autenticacao"
- Sim: Dividir em: schema → migration → service → middleware → testes
